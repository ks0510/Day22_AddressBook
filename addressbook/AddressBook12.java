/*
 * This java program sort the address book with respect to city,state and zip. 
 */
package addressbook;
import java.util.*;
...
public class AddressBook12 {
	...
	/*
	 *To define method to sort addressbook with respect to city name. 
	 */
	public static void sortbyCity(ArrayList<Person1> list) {
		 
		 list.sort((obj1, obj2)
	                  -> obj1.getCity().compareTo(
	                      obj2.getCity()));
    }
	
	/*
	 *To define method to sort addressbook with respect to state name. 
	 */
	public static void sortbyState(ArrayList<Person1> list) {
		 
		 list.sort((obj1, obj2)
	                  -> obj1.getState().compareTo(
	                      obj2.getState()));
    }
	
	/*
	 *To define method to sort addressbook with respect to zip. 
	 */
	public static void sortbyZip(ArrayList<Person1> list) {
		 
		 list.sort((obj1, obj2)
	                  -> Integer.compare(obj1.getZip(),obj2.getZip()));
    }
	...
	public static void main(String[] args) throws IOException {
        ...
        /*
         * To sort with respect to city name
         */
        sortbyCity(addressBook1);
        
        System.out.println(addressBook1);
        
        /*
         * To sort with respect to state name
         */
        sortbyState(addressBook1);
        
        System.out.println(addressBook1);
        
        /*
         * To sort with respect to zip
         */
        sortbyZip(addressBook1);
